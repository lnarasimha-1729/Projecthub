...
const BudgetChart = () => {
  ...
  return (
    <div className="w-full h-[400px] bg-white shadow-sm py-14 rounded-lg">
      <p className="text-center text-xs            /* default (mobile) */
  sm:text-sm         /* small screens */
  md:text-base       /* medium screens */
  lg:text-lg         /* large screens */
  xl:text-xl font-semibold mb-2">Project Budget Overview</p>
